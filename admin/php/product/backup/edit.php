...
if (!isset($_SESSION['user_id'])) {
	...
	$sql = "UPDATE products SET product_name='$product_name', dimensions='$dimensions', description='$description', new_arrivals='$is_new_arrival', best_sellers='$best_seller', main_cat='$main_category' WHERE id='$p_id'";
